...
function getBarColor(index, compare, pivot) {
...
function drawArray(step) {
    ...
    const pivot = step.pivot !== undefined ? step.pivot : -1;
    ...
    arr.forEach(function (num, index) {
        ...
        bar.style.background = getBarColor(index, compare, pivot);
...
async function startQuickSort() {
    ...
    try {
        globalSteps = await fetchSortSteps("quick", arr);
    } catch (e) {
